...
export const platformTourContent: Record<Locale, PlatformTourContent> = {
  nl: {
    ...
    interactionHint: 'Gebruik twee vingers of scroll om te zoomen, sleep om te verplaatsen en druk op 0 om te resetten.',
    slides: [
      ...
      { id: 'resolve', label: 'Afhandeling', title: 'Afronden met expliciete uitkomst', text: 'Afhandelen dwingt een expliciete uitkomst af, zodat afsluiting en latere reconstructie niet vaag blijven.', alt: 'Velvoix afhandeldialoog', ...slideFraming.resolve },
      { id: 'assign', label: 'Toewijzen', title: 'Snel de juiste collega koppelen', text: 'Toewijzen maakt verantwoordelijkheid direct zichtbaar, zodat signalen niet tussen collega\'s blijven hangen.', alt: 'Velvoix toewijzingsdialoog', ...slideFraming.assign },
      { id: 'handover', label: 'Overdracht', title: 'Overdragen met traceerbaarheid', text: 'Overdracht houdt reden, eigenaar en vervolg bij elkaar, zodat context tussen diensten niet wegvalt.', alt: 'Velvoix overdrachtsdialoog', ...slideFraming.handover },
  ...
  en: {
    ...
    slides: [
      { id: 'login', label: 'Start', title: 'A calm entry point', text: 'The login keeps access calm and familiar so teams can start the day without extra friction.', alt: 'Velvoix login screen', ...slideFraming.login },
  ...
  es: {
    ...
    slides: [
      ...
      { id: 'worklist', label: 'Bandeja', title: 'Señales en una lista fácil de gestionar', text: 'La urgencia, el estado y la responsabilidad permanecen juntos para que el seguimiento abierto no se fragmente entre señales separadas.', alt: 'Lista de trabajo de Velvoix', ...slideFraming.worklist },
