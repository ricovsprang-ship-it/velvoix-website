...
export const platformTourContent: Record<Locale, PlatformTourContent> = {
  ...
  de: {
    ...
    supporting:
      'Offnen Sie die Produkttour fur einen ruhigen Blick auf die wichtigsten operativen Bildschirme.',
    cta: 'Produkttour offnen',
    previewLabel: 'Ausgewahlter Bildschirm',
    previewTitle: 'Eventdetail mit Kontext und Aktion',
    previewBody:
      'Ein Beispiel dafur, wie Begrundung, Kontext und Aktionen auf einem ruhigen operativen Bildschirm zusammenkommen.',
    ...
    slides: [
      ...
      { id: 'event-detail', label: 'Eventdetail', title: 'Warum, Kontext und Aktion zusammen', text: 'Begrundung, Kontext, Zeitlinie und Aktionen bleiben auf einem ruhigen operativen Bildschirm zusammen.', alt: 'Velvoix Eventdetail', ...slideFraming['event-detail'] },
  ...
  es: {
    ...
    previewBody:
      'Un ejemplo de como motivo, contexto y acciones se reunen en una pantalla operativa serena.',
    ...
    slides: [
      ...
      { id: 'event-detail', label: 'Detalle del evento', title: 'Motivo, contexto y accion juntos', text: 'Motivo, contexto, linea temporal y acciones permanecen reunidos en una pantalla operativa serena.', alt: 'Detalle del evento de Velvoix', ...slideFraming['event-detail'] },
