...
export const platformTourContent: Record<Locale, PlatformTourContent> = {
  nl: {
    ...
    title: 'Een rustig inkijkje in het platform',
    description:
      'Een rustige tour langs de schermen die in de dagelijkse operatie het verschil maken: events, context, opvolging, beheer en governance.',
    supporting:
      'Geen documentviewer, maar een compacte tour met leesbare desktopweergaven van werkvoorraad, context en operationele sturing.',
    cta: 'Bekijk tour',
    previewLabel: 'Preview',
    previewTitle: 'Tien geselecteerde schermen',
    previewBody: 'Van werkvoorraad en eventdetail tot toewijzen, afhandeling, beheer en governance.',
    ...
    slides: [
      ...
      { id: 'event-detail', label: 'Eventdetail', title: 'Waarom en aanpak bijeen', text: 'De eventdetailweergave bundelt reden, context, tijdlijn en acties in een operationeel geheel.', alt: 'Velvoix eventdetail', ...slideFraming['event-detail'] },
      ...
      { id: 'handover', label: 'Afhandeling', title: 'Overdragen en afronden met reden', text: 'Overdracht en afronding blijven gestructureerd, uitlegbaar en geschikt voor log en audit.', alt: 'Velvoix overdracht en afhandeling', ...slideFraming.handover },
      { id: 'client-context', label: 'Cliënthistorie', title: 'Relevante context op één plek', text: 'Zorgcontext, recente events en opvolgingshistorie blijven direct beschikbaar voor zorgvuldige opvolging.', alt: 'Velvoix cliëntcontext', ...slideFraming['client-context'] },
      ...
      { id: 'management', label: 'Beheer', title: 'Beheer dat rustig blijft', text: 'Koppelingen, beschikbaarheid en werkvolgorde blijven overzichtelijk zonder extra beheerruis.', alt: 'Velvoix beheer', ...slideFraming.management },
  ...
  en: {
    ...
    title: 'A calm view of the platform',
    description:
      'A calm tour through the screens that make the operational difference: events, context, follow-up, management and governance.',
    supporting:
      'Not a document viewer, but a compact tour with readable desktop views of worklists, context and operational control.',
    cta: 'View tour',
    previewLabel: 'Preview',
    previewTitle: 'Ten selected desktop views',
    previewBody: 'From worklist and event detail to assignment, handling, management and governance.',
    ...
    slides: [
      ...
      { id: 'event-detail', label: 'Event Detail', title: 'Why and action together', text: 'The event detail view keeps reason, context, timeline and actions together in one operational view.', alt: 'Velvoix event detail', ...slideFraming['event-detail'] },
      ...
      { id: 'handover', label: 'Handling', title: 'Transfer and resolve with a reason', text: 'Transfer and completion remain structured, explainable and suitable for logging and audit.', alt: 'Velvoix handover and completion dialog', ...slideFraming.handover },
  ...
  de: {
    ...
    supporting:
      'Keine Dokumentansicht, sondern eine kompakte Tour mit lesbaren Desktopansichten fur Arbeitsvorrat, Kontext und operative Steuerung.',
    cta: 'Tour ansehen',
    previewLabel: 'Vorschau',
    previewTitle: 'Zehn ausgewahlte Ansichten',
    previewBody: 'Von Arbeitsvorrat und Eventdetail bis zu Zuweisung, Bearbeitung, Verwaltung und Governance.',
    ...
    slides: [
      ...
      { id: 'event-detail', label: 'Eventdetail', title: 'Warum und Aktion zusammen', text: 'Die Eventdetailansicht bundelt Begrundung, Kontext, Zeitlinie und Aktionen in einer operativen Ansicht.', alt: 'Velvoix Eventdetail', ...slideFraming['event-detail'] },
      ...
      { id: 'handover', label: 'Bearbeitung', title: 'Mit Begrundung ubergeben und abschliessen', text: 'Ubergabe und Abschluss bleiben strukturiert, erklarbar und fur Log und Audit geeignet.', alt: 'Velvoix Bearbeitung', ...slideFraming.handover },
  ...
  es: {
    ...
    supporting:
      'No es un visor de documentos, sino un recorrido compacto con vistas de escritorio legibles de lista de trabajo, contexto y control operativo.',
    cta: 'Ver recorrido',
    previewLabel: 'Vista previa',
    previewTitle: 'Diez vistas seleccionadas',
    previewBody: 'Desde la lista de trabajo y el detalle del evento hasta asignacion, gestion y gobernanza.',
    ...
    slides: [
      ...
      { id: 'event-detail', label: 'Detalle del evento', title: 'Motivo y accion juntos', text: 'La vista de detalle mantiene razon, contexto, linea temporal y acciones dentro del mismo flujo operativo.', alt: 'Detalle del evento de Velvoix', ...slideFraming['event-detail'] },
      ...
      { id: 'handover', label: 'Transferencia', title: 'Transferir y cerrar con motivo claro', text: 'La transferencia y el cierre siguen siendo estructurados, explicables y aptos para registro y auditoria.', alt: 'Dialogo de transferencia de Velvoix', ...slideFraming.handover },
