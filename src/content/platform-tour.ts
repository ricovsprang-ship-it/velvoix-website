...
export const platformTourContent: Record<Locale, PlatformTourContent> = {
  nl: {
    ...
    cta: 'Open fullscreen platformtour',
  ...
  en: {
    ...
    cta: 'Open fullscreen platform tour',
    previewLabel: 'Preview',
  ...
  de: {
    ...
    supporting:
      'Eine kuratierte Tour statt eines Dokumentenviewers: lesbare Desktopansichten, die zeigen, wie Velvoix Arbeitsvorrat, Kontext und operative Steuerung zusammenhalt.',
    cta: 'Plattformtour im Vollbild offnen',
    ...
    slides: [
      ...
      { id: 'assign', label: 'Zuweisen', title: 'Schnell die richtige Kollegin oder den richtigen Kollegen verknupfen', text: 'Die Zuweisung bleibt ruhig und zielgerichtet, ohne den Eventkontext zu verlassen.', alt: 'Velvoix Zuweisung', ...slideFraming.assign },
      ...
      { id: 'client-context', label: 'Clienthistorie', title: 'Relevanter Kontext an einem Ort', text: 'Pflegekontext, letzte Events und Nachverfolgungshistorie bleiben fur eine sichere Folgeaktion direkt verfugbar.', alt: 'Velvoix Clienthistorie', ...slideFraming['client-context'] },
  ...
  es: {
    ...
    supporting:
      'Un recorrido curado, no un visor de documentos: vistas de escritorio legibles que muestran como Velvoix mantiene unidos la lista de trabajo, el contexto y el control operativo.',
    cta: 'Abrir el recorrido de plataforma a pantalla completa',
    ...
    slides: [
      { id: 'login', label: 'Inicio', title: 'Entrada serena en la plataforma', text: 'Velvoix empieza con un acceso claro y tranquilo al workflow operativo.', alt: 'Pantalla de acceso de Velvoix', ...slideFraming.login },
      ...
      { id: 'handover', label: 'Gestion', title: 'Transferir y resolver con un motivo claro', text: 'La transferencia y el cierre siguen siendo estructurados, explicables y aptos para registro y auditoria.', alt: 'Dialogo de transferencia de Velvoix', ...slideFraming.handover },
