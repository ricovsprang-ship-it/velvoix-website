...
const slideFraming = {
  login: {
    image: '/products/platformtour/login-20260516.webp',
    objectPosition: 'center center',
    baseScale: 1,
    initialZoom: 1,
    zoomOrigin: '50% 50%',
  },
  profile: { image: '/products/platformtour/profile-20260516.webp', ...defaultFraming },
  worklist: { image: '/products/platformtour/worklist-20260516.webp', ...defaultFraming },
  notifications: { image: '/products/platformtour/notifications-20260516.webp', ...defaultFraming },
  'event-detail': { image: '/products/platformtour/event-detail-20260516.webp', ...defaultFraming },
  resolve: { image: '/products/platformtour/resolve-20260516.webp', ...defaultFraming },
  assign: { image: '/products/platformtour/assign-20260516.webp', ...defaultFraming },
  handover: { image: '/products/platformtour/handover-20260516.webp', ...defaultFraming },
  'resident-overview': { image: '/products/platformtour/resident-overview-20260516.webp', ...defaultFraming },
  'resident-history': { image: '/products/platformtour/resident-history-20260516.webp', ...defaultFraming },
  'resident-context': { image: '/products/platformtour/resident-context-20260516.webp', ...defaultFraming },
  'resident-statistics': { image: '/products/platformtour/resident-statistics-20260516.webp', ...defaultFraming },
  'care-operations': { image: '/products/platformtour/care-operations-20260516.webp', ...defaultFraming },
  'quality-response': { image: '/products/platformtour/quality-response-20260516.webp', ...defaultFraming },
  'workload-hotspots': { image: '/products/platformtour/workload-hotspots-20260516.webp', ...defaultFraming },
  'facility-linking': { image: '/products/platformtour/facility-linking-20260516.webp', ...defaultFraming },
  'access-control': { image: '/products/platformtour/access-control-20260516.webp', ...defaultFraming },
  'audit-log': { image: '/products/platformtour/audit-log-20260516.webp', ...defaultFraming },
...
export const platformTourContent: Record<Locale, PlatformTourContent> = {
  nl: {
    ...
    slides: [
      ...
      { id: 'profile', label: 'Profiel', title: 'Eigen beschikbaarheid en toegang op een plek', text: 'Mijn profiel brengt accountgegevens, werkvloerbeschikbaarheid en wachtwoordbeheer samen zonder een tweede dashboard te worden.', alt: 'Velvoix profielpagina met beschikbaarheid en wachtwoordbeheer', ...slideFraming.profile },
  ...
  en: {
    ...
    slides: [
      ...
      { id: 'profile', label: 'Profile', title: 'Availability and access in one place', text: 'My profile brings account details, workfloor availability and password management together without becoming a second dashboard.', alt: 'Velvoix profile page with availability and password management', ...slideFraming.profile },
  ...
  de: {
    ...
    slides: [
      ...
      { id: 'profile', label: 'Profil', title: 'Verfuegbarkeit und Zugang an einem Ort', text: 'Mein Profil fuehrt Kontodaten, Verfuegbarkeit im Arbeitsablauf und Passwortverwaltung zusammen, ohne ein zweites Dashboard zu werden.', alt: 'Velvoix Profilseite mit Verfuegbarkeit und Passwortverwaltung', ...slideFraming.profile },
  ...
  es: {
    ...
    slides: [
      ...
      { id: 'profile', label: 'Perfil', title: 'Disponibilidad y acceso en un solo lugar', text: 'Mi perfil reune datos de cuenta, disponibilidad operativa y gestion de contrasena sin convertirse en un segundo panel.', alt: 'Pagina de perfil de Velvoix con disponibilidad y gestion de contrasena', ...slideFraming.profile },
