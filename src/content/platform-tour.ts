...
export const platformTourContent: Record<Locale, PlatformTourContent> = {
  nl: {
    ...
    slides: [
      ...
      { id: 'event-detail', label: 'Eventdetail', title: 'Waarom, context en aanpak bijeen', text: 'Reden, context, tijdlijn en acties komen samen in een rustige operationele weergave.', alt: 'Velvoix eventdetail', ...slideFraming['event-detail'] },
  ...
  en: {
    ...
    previewBody:
      'One example of how reason, context and actions come together on one calm operational screen.',
    ...
    slides: [
      ...
      { id: 'event-detail', label: 'Event Detail', title: 'Why, context and action together', text: 'Reason, context, timeline and actions stay together on one calm operational screen.', alt: 'Velvoix event detail', ...slideFraming['event-detail'] },
  ...
  de: {
    ...
    description:
      'Zehn ausgewählte Ansichten zeigen, wie Velvoix Arbeitsvorrat, Kontext, Nachverfolgung, Verwaltung und Governance ordnet.',
    supporting:
      'Öffnen Sie die Produkttour für einen ruhigen Blick auf die wichtigsten operativen Bildschirme.',
    cta: 'Produkttour öffnen',
    previewLabel: 'Ausgewählter Bildschirm',
    previewTitle: 'Eventdetail mit Kontext und Aktion',
    previewBody:
      'Ein Beispiel dafür, wie Begründung, Kontext und Aktionen auf einem ruhigen operativen Bildschirm zusammenkommen.',
    ...
    slides: [
      { id: 'login', label: 'Start', title: 'Ruhiger Einstieg', text: 'Der Einstieg hält den Zugang zum operativen Workflow klar und kontrolliert.', alt: 'Velvoix Login', ...slideFraming.login },
      { id: 'worklist', label: 'Arbeitsvorrat', title: 'Arbeitsvorrat, der lesbar bleibt', text: 'Dringlichkeit, Status und Aktionen bleiben scanbar, damit Teams schneller handeln können.', alt: 'Velvoix Arbeitsvorrat', ...slideFraming.worklist },
      ...
      { id: 'event-detail', label: 'Eventdetail', title: 'Warum, Kontext und Aktion zusammen', text: 'Begründung, Kontext, Zeitlinie und Aktionen bleiben auf einem ruhigen operativen Bildschirm zusammen.', alt: 'Velvoix Eventdetail', ...slideFraming['event-detail'] },
      ...
      { id: 'handover', label: 'Übergabe', title: 'Mit Kontext übergeben und abschließen', text: 'Übergabe und Abschluss bleiben erklärbar und für die Rückschau geeignet.', alt: 'Velvoix Bearbeitung', ...slideFraming.handover },
      { id: 'client-context', label: 'Klientenhistorie', title: 'Relevanter Kontext direkt zur Hand', text: 'Pflegekontext, letzte Events und Nachverfolgung bleiben direkt verfügbar.', alt: 'Velvoix Klientenhistorie', ...slideFraming['client-context'] },
      { id: 'care-overview', label: 'Pflegeübersicht', title: 'Steuerung ohne Dashboard-Rauschen', text: 'Der operative Überblick zeigt, wo Druck, Trend und SLA-Risiko steigen.', alt: 'Velvoix Pflegeübersicht', ...slideFraming['care-overview'] },
      { id: 'management', label: 'Verwaltung', title: 'Verwaltung ohne Zusatzrauschen', text: 'Kopplungen, Verfügbarkeit und Arbeitsreihenfolge bleiben klar und kontrolliert.', alt: 'Velvoix Verwaltung', ...slideFraming.management },
      { id: 'governance', label: 'Governance', title: 'Governance in einer geführten Ebene', text: 'Profile, Qualität und technische Kopplungen bleiben gemeinsam organisiert.', alt: 'Velvoix Governance', ...slideFraming.governance },
    ],
  },
  es: {
    ...
    description:
      'Diez pantallas seleccionadas muestran cómo Velvoix ordena la lista de trabajo, el contexto, el seguimiento, la gestión y la gobernanza.',
    supporting:
      'Abra el recorrido del producto para ver con calma las pantallas operativas clave.',
    cta: 'Abrir recorrido',
    previewLabel: 'Pantalla seleccionada',
    previewTitle: 'Detalle del evento con contexto y acción',
    previewBody:
      'Un ejemplo de cómo el motivo, el contexto y las acciones se reúnen en una pantalla operativa serena.',
    ...
    slides: [
      ...
      { id: 'worklist', label: 'Lista de trabajo', title: 'Lista de trabajo que sigue siendo legible', text: 'La urgencia, el estado y las acciones siguen siendo fáciles de escanear para actuar con más rapidez.', alt: 'Lista de trabajo de Velvoix', ...slideFraming.worklist },
      { id: 'notifications', label: 'Notificaciones', title: 'Nuevas señales sin ruido', text: 'Las nuevas señales se vuelven visibles sin dispersar la atención del equipo.', alt: 'Vista de notificaciones de Velvoix', ...slideFraming.notifications },
      { id: 'event-detail', label: 'Detalle del evento', title: 'Motivo, contexto y acción juntos', text: 'El motivo, el contexto, la línea temporal y las acciones permanecen reunidos en una pantalla operativa serena.', alt: 'Detalle del evento de Velvoix', ...slideFraming['event-detail'] },
      { id: 'assign', label: 'Asignar', title: 'Vincular rápidamente a la persona adecuada', text: 'La asignación se mantiene directa sin perder el contexto del evento.', alt: 'Diálogo de asignación de Velvoix', ...slideFraming.assign },
      { id: 'handover', label: 'Transferencia', title: 'Transferir y cerrar con contexto', text: 'La transferencia y el cierre siguen siendo explicables y aptos para revisión.', alt: 'Diálogo de transferencia de Velvoix', ...slideFraming.handover },
      ...
      { id: 'care-overview', label: 'Resumen asistencial', title: 'Dirección sin ruido de paneles', text: 'La vista operativa muestra dónde suben presión, tendencia y riesgo SLA.', alt: 'Resumen asistencial de Velvoix', ...slideFraming['care-overview'] },
      { id: 'management', label: 'Administración', title: 'Gestión sin ruido adicional', text: 'Las vinculaciones, la disponibilidad y el orden de trabajo siguen claros y controlados.', alt: 'Vista de administracion de Velvoix', ...slideFraming.management },
      { id: 'governance', label: 'Gobernanza', title: 'Gobernanza en una capa controlada', text: 'Los perfiles, la calidad y el acoplamiento técnico permanecen organizados juntos.', alt: 'Vista de gobernanza de Velvoix', ...slideFraming.governance },
    ],
  },
};
