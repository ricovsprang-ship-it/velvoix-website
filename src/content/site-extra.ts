...
export const deContent: SiteContent = {
  ...
  challenge: {
    ...
    proofPanels: {
      explainabilityLabel: 'Meldung & Begründung',
      explainabilityTitle: 'Warum',
      explainabilitySummary: 'Eine Bewohnerin oder ein Bewohner meldet einen Sturz und kann nicht mehr aufstehen.',
      explainabilitySupporting: 'Grund, Kontext und Begründung bleiben für eine schnelle Einschätzung zusammen sichtbar.',
      explainabilityItems: [
        { label: 'Transkript', value: '"Ich bin gestürzt und kann nicht mehr aufstehen."' },
        { label: 'Aktuelle Situation', value: 'Die Meldung steht offen in der Arbeitsliste.' },
      ...
      followUpItems: [
        ...
        { label: 'Zugewiesen an', value: 'Noch nicht zugewiesen' },
        { label: 'Kernstatus', value: 'Offen' },
      ],
  ...
  challenge: {
    ...
    proofPanels: {
      ...
      explainabilityItems: [
        ...
        { label: 'Situación actual', value: 'La alerta está abierta en la cola de trabajo.' },
        { label: 'Fundamento', value: 'La señal, el contexto relevante y el efecto permanecen visibles juntos.' },
      ],
